...
#define NTMAX 5000
#define DR RCUT/NTMAX
#define DRI NTMAX/RCUT
...
gl[0|1|2] = Total Box length in the x|y|z direction.
ol[0|1|2] = Origin of Box per processor in the x|y|z direction.
